...
func mastorBuilder() *flatbuffers.Builder {
	builder := flatbuffers.NewBuilder(0)
	var sword, axe flatbuffers.UOffsetT
	{
	...
	//
	var weapons flatbuffers.UOffsetT
	{
